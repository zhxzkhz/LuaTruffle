...
public abstract class LuaToBooleanNode extends LuaExpressionNode {
    ...
    @Specialization
    public static boolean doLuaBoolean(LuaBoolean value) {
        return value.getValue();
    }

    @Specialization
    public static boolean doLuaNil(LuaNil value) {
        return false;
    }
