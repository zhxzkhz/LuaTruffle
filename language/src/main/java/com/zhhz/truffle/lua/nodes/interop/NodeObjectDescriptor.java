 ...
 * SOFTWARE.
 */
package com.zhhz.truffle.lua.nodes.interop;
...
public abstract class NodeObjectDescriptor implements TruffleObject {
    ...
    static final class ReadDescriptor extends NodeObjectDescriptor {
        ...
        private static final TruffleObject KEYS_READ = new NodeObjectDescriptorKeys(LuaContext.toTruffleString(StandardTags.ReadVariableTag.NAME));
    ...
    static final class WriteDescriptor extends NodeObjectDescriptor {
        ...
        private static final TruffleObject KEYS_WRITE = new NodeObjectDescriptorKeys(LuaContext.toTruffleString(StandardTags.WriteVariableTag.NAME));
